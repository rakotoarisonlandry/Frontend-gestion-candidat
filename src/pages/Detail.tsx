    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      ...
      <main className="relative max-w-2xl mx-auto px-6 py-10">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Détails du candidat</h1>
        </div>
          ...
          <div className="bg-[#111118] border border-white/8 rounded-3xl p-8 shadow-2xl">
            ...
            <div className="grid grid-cols-1 gap-4 mb-8">
               <div className="bg-white/5 rounded-2xl p-4 border border-white/5">
                  <p className="text-zinc-500 text-xs uppercase tracking-wider font-bold mb-1">ID Candidat</p>
